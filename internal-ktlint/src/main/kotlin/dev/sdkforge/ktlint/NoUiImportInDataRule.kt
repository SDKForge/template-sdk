...
class NoUiImportInDataRule() : Rule(
    ...
    override fun beforeVisitChildNodes(
        ...
        when (node.elementType) {
            ...
            KtStubElementTypes.IMPORT_DIRECTIVE -> {
                ...
                val isDataImport = currentImportPath.contains(UI_MODULE_NAME)
                val isPackageNameValid = lastPackageName.contains(DATA_MODULE_NAME)
    ...
    companion object {
        ...
        private const val UI_MODULE_NAME = "ui"
        private const val DATA_MODULE_NAME = "data"

        val RULE_VIOLATION_MESSAGE =
            "Importing: $currentImportPath. $UI_MODULE_NAME module import is not allowed in $DATA_MODULE_NAME module"
    }
}
